...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    @foreach ($fields as $field)
        ...
        {{-- state/city را در این حلقه رندر نکن --}}
        @if(in_array($id, ['state','city']))
            @continue
        @endif
    ...
    {{-- استان/شهر با فیلتر لایو - نسخهٔ خودکفا بدون وابستگی به فایل JS خارجی --}}
    <div class="col-span-2">
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select name="city" id="citySelect" class="form-control mt-1" {{ old('state', $lead->state ?? '') ? '' : 'disabled' }}>
                ...
                (function(){
                    ...
                    // اگر مقدار اولیه داری (edit form)
    ...
    {{-- وضعیت سرنخ --}}
    @php $lead_status_value = old('lead_status', isset($lead) ? $lead->lead_status : 'new'); @endphp
    <div class="col-span-1">
