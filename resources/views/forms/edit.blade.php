                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('forms.update', $form) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-input id="title" class="block mt-1 w-full" type="text" name="title" :value="old('title', $form->title)" required autofocus />
                        ...
                        <div>
                            ...
                            <x-input id="purchase_date" class="block mt-1 w-full" type="date" name="purchase_date" :value="old('purchase_date', $form->purchase_date->format('Y-m-d'))" required />
                        ...
                        <div>
                            ...
                            <x-input id="total" class="block mt-1 w-full" type="number" name="total" :value="old('total', $form->total)" required />
