                                ...
                                <div class="space-y-2">
                                    @foreach($activeGroup->memberships as $member)
                                        <div class="flex items-center justify-between gap-2 rounded-lg border border-gray-100 px-2 py-2">
                                            <div class="flex items-center gap-2">
                                                <span class="inline-flex items-center justify-center w-3 h-3 rounded-full border border-gray-400 text-[8px] leading-none text-gray-400"
                                                      data-presence-indicator
                                                      data-user-id="{{ $member->user_id }}">×</span>
