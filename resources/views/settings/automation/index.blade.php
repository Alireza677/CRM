...
@php
    $breadcrumb = [
        ['title' => 'اتوماسیون'],
        ['title' => 'قوانین ارسال سرنخ فروش برای تایید']
    ];
...
<div class="max-w-5xl mx-auto px-4 py-8 space-y-6">
    <div class="flex items-center justify-between gap-3">
        <div>
            <h1 class="text-xl font-semibold text-gray-800">اتوماسیون قوانین ارسال سرنخ فروش برای تایید</h1>
            <p class="mt-1 text-sm text-gray-600">در این بخش می‌توانید قوانین ارجاع سرنخ‌های فروش برای تایید را تعریف و مدیریت کنید.</p>
        </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800">افزودن قانون</h2>
            <p class="mt-1 text-sm text-gray-600">برای ارسال خودکار سرنخ فروش به جریان تایید، قانون جدید تعریف کنید.</p>
        </div>
            ...
            <form action="{{ route('settings.automation.update') }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="flex flex-col space-y-2">
                        <label class="text-sm font-medium text-gray-700">فیلد</label>
                        <input type="text" value="مرحله ارسال برای تایید" readonly class="rounded-lg border border-gray-300 bg-gray-50 px-3 py-2 text-sm text-gray-700">
                    </div>

                    <div class="flex flex-col space-y-2">
                        <label class="text-sm font-medium text-gray-700">عملگر</label>
                    ...
                    <div class="flex flex-col space-y-2">
                        <label class="text-sm font-medium text-gray-700">مقدار</label>
                ...
                <div class="space-y-3">
                    <label class="text-sm font-semibold text-gray-800">تاییدکنندگان</label>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex flex-col space-y-2">
                            <label for="approver_1" class="text-sm font-medium text-gray-700">تاییدکننده اول</label>
                        ...
                        <div class="flex flex-col space-y-2">
                            <label for="approver_2" class="text-sm font-medium text-gray-700">تاییدکننده دوم</label>
                        ...
                        <div class="flex flex-col space-y-2 md:col-span-2">
                            <label for="emergency_approver_id" class="text-sm font-medium text-gray-700">تاییدکننده اضطراری (در صورت عدم پاسخ)</label>
                            ...
                            <p class="text-xs text-gray-500">
                                اگر تاییدکنندگان اصلی در زمان مشخص اقدام نکنند، سرنخ برای تایید به تاییدکننده اضطراری ارجاع می‌شود.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">لیست قوانین</h3>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-right font-semibold text-gray-700">فیلد</th>
                        <th class="px-4 py-3 text-right font-semibold text-gray-700">عملگر</th>
                        <th class="px-4 py-3 text-right font-semibold text-gray-700">مقدار</th>
                        <th class="px-4 py-3 text-right font-semibold text-gray-700">تاییدکننده اول</th>
                        <th class="px-4 py-3 text-right font-semibold text-gray-700">تاییدکننده دوم</th>
                        <th class="px-4 py-3 text-right font-semibold text-gray-700">تاییدکننده اضطراری</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-200">
                    @forelse(($rules ?? collect()) as $item)
                        <tr class="bg-white">
                            ...
                            <td class="px-4 py-3 text-gray-800">مرحله ارسال برای تایید</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-4 py-6 text-center text-gray-600">هیچ قانونی ثبت نشده است.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
