            ...
            <form method="POST" action="{{ route('sales.organizations.store') }}">
                ...
                <div class="mb-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="is_favorite" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        <span class="mr-2 text-sm text-gray-600">مورد علاقه</span>
                    </label>
                </div>
